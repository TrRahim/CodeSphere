  ...
  return (
    <div className="relative" ref={dropDownRef}>
      <motion.button
        ...
        bg-[#1e1e2e]/80 hover:bg-[#262637] rounded-lg transition-all 
         first-letter:duration-200 border border-gray-800/50 hover:border-gray-700"
      >
        <div
        ...
        <div
          ...
          style={{ background: currentTheme?.label }}
        />
      </motion.button>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {THEMES.map((th, index) => (
              <motion.div
                ...
                className={`relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#262637] transition-all duration-200 ${theme == th.id ? "bg-blue-500/10 text-blue-400" : "text-gray-300"} `}
              ...
              >
                ...
                <div
                  className={`flex items-center justify-center size-8 rounded-lg ${theme == th.id ? "bg-blue-500/10 text-blue-400" : "bg-gray-800/50 text-gray-400"} 
                    group-hover:scale-110 transition-all duration-200`}
                >
                  {THEME_ICONS[th.id] || <CircleOff className="w-4 h-4" />}
                </div>
